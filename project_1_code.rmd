...
We first plot to compare between the overall duration for member vs non-member, weekend vs weekday, day vs night, and temperature intervals to intuitively see if there's a difference.
```{r}
