...
length(final$noncoverage_rates_2010.route)
```

After adjusting for multiple testing issue, we report 76 significant routes. 
...
```{r echo=FALSE, fig.align='center', fig.height=2.8, fig.width=5.6, cache=TRUE}
...
```{r echo=FALSE, fig.align='center', fig.height=3, fig.width=6, cache=TRUE}
